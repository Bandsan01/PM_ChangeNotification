		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comappzuichangenot-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappzuichangenot-display": {
								"semanticObject": "comappzuichangenot",
								"action": "display",
								"description": "Change of Notification",
								"title": "Change Notification",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.zuichangenot",
									"url": sap.ui.require.toUrl("com/app/zuichangenot")
								}
							}
						}
					}
